...
\cventry{2019 -- prés.}{Chercheur en écologie}{Cirad, UMR AMAP} {Montpellier (France)}{Etude du fonctionnement des forêts tropicales}{}
\cventry{2024 -- 2025}{Expatriation en Nouvelle-Calédonie}{Cirad, UMR AMAP, IAC} {Nouméa (Nouvelle-Calédonie)}{Ecologie et conservation des forêts tropicales en Mélanésie}{}
...
\cventry{2009 -- 2018}{Chercheur en écologie}{Cirad, UPR Forêts et Sociétés} {Montpellier (France)}{Etude du fonctionnement des forêts tropicales}{}
...
\cvline{2026}{\textbf{Ecole doctorale GAIA, Université de Montpellier.} En cours: \emph{Habilitation à diriger des recherches (HDR)}. Mesure et déterminants du carbone et de la biodiversité dans les forêts tropicales -- Applications à la conservation des forêts et à l'atténuation du changement climatique. \textit{Rapport déposé en avril 2026, soutenance prévue fin 2026.}}

\cvline{2006 -- 2009}{\textbf{Cemagref de Grenoble, AgroParisTech.}  \emph{Thèse de doctorat (PhD)} en statistiques appliquées à l'écologie forestière. Mécanismes de coexistence du sapin pectiné et de l'épicéa commun en forêt de montagne.}

\cvline{2004 -- 2006}{\textbf{Chambre d'Agriculture de la Lozère, CLAPE-LR, FREDEC-MP.} Ingénieur agronome chargé d'études.}

\cvline{2003 -- 2004}{\textbf{Muséum National d'Histoire Naturelle (MNHN), INA-PG, Paris VII.} \emph{Diplôme d'études approfondies (DEA).} Environnement: Milieux, Techniques et Sociétés (EMTS).}

\cvline{2001}{\textbf{Escuela Técnica Superior de Ingenieros Agronomos y Montes (ETSIAM), Cordoue (Espagne).} Semestre d'étude à l'étranger. Sylviculture et conservation des habitats méditerranéens.}

\cvline{2000 -- 2003}{\textbf{Ecole Nationale Supérieure Agronomique de Rennes (ENSAR).} \emph{Diplôme d'ingénieur agronome.}  Agronomie, écologie quantitative et conservation des milieux naturels.}

\cvline{1996 -- 1999}{\textbf{Lycée Georges Clémenceau, Nantes.} 1997 -- 1999: Classes préparatoires
  BCPST, 1996 -- 1997: baccalauréat S option mathématiques.}

\section{Compétences en informatique, langues et botanique}

\cvline{\textbf{Langages}}{R, Python, C/C++, Bash, SQL, GRASS GIS}
...
\cvline{\textbf{Botanique}}{Identification des principales familles de plantes tropicales (formation à Kew Botanical Garden). Intérêt pour les inventaires botaniques.}

\section{Projets de recherche}

\cvline{}{Depuis 2009: coordination de 3 projets scientifiques, responsable de work-packages pour 1 projet, participation à 6 autres projets scientifiques et réalisation de 7 projets d'expertises.}
...
\cvline{2021 -- 2023}{Projet \textbf{INTRACO}, Rôle de la variabilité intraspécifique dans la coexistence des espèces d'arbres en forêt tropicale, \textbf{FRB-Cesab -- sDiv}, 4 workshops ($\sim$ 40 000 \euro). Page du projet sur le site du \href{https://www.fondationbiodiversite.fr/la-frb-en-action/programmes-et-projets/le-cesab/intraco/}{\texttt{Cesab}.}}
...
\cvline{2019 -- 2022}{Projet \textbf{RELIQUES}, Effet de la fragmentation des forêts sur la biodiversité en Nouvelle-Calédonie, \textbf{CNRT}, 251 380 \euro. Coordination: Philippe Birnbaum (Cirad, UMR AMAP). \url{https://cnrt.nc/reliques}}

\vspace{0.3cm}
\subsection{Participation aux projets}

\cvline{2024 -- 2030}{Projet \textbf{PC MONITOR}, "Système agile de monitoring écologique des forêts", \textbf{ANR, PEPR FORESTT}, 6 M \euro. Coordination: Jérôme Chave (CNRS, Université de Toulouse) et Sylvain Schmitt (CIRAD, UPR Forêts et Sociétés).}

\cvline{2024 -- 2025}{Projet \textbf{MELANOBS}, "Melanesian forest observatory", \textbf{IRD, Fonds Pacifique, NYBG}, 168 410 \euro. Coordination: Thomas Ibanez (IRD, UMR AMAP).}
...
\cvline{2024}{Développement du plugin QGIS \textbf{deforisk} pour l'obtention et la comparaison de cartes de risque de déforestation, \textbf{FAO}, 60 188 \euro.}
...
\cvline{2012 -- 2013}{Appui technique à l'Office National pour l'Environnement dans la mise en place du programme REDD+ pour la gestion et la conservation des forêts à Madagascar, \textbf{AFD}, 290 210 \euro.}

\cvline{2012}{Architecture des arbres dans les forêts sèches de l'ouest de Madagascar, \textbf{WWF}, 3500 \euro.}
...
\cvline{}{Depuis 2009: Développement et maintenance de 4 packages R, 4 packages Python et 1 plugin QGis. Contribution à 1 package R et 1 package Python. Mise en ligne de 99 répertoires \href{https://github.com/ghislainv}{\texttt{GitHub}} publics et de 7 dépôts \href{https://dataverse.cirad.fr/dataverse/CIRAD/?q=\%28authorName\%3Aghislain+authorName\%3Avieilledent\%29}{\texttt{Dataverse Cirad}}.}
...
\cvline{\textbf{geefcc}}{Le package \textbf{geefcc} permet de créer des cartes de changement de couverture forestière à partir de Google Earth Engine (GEE). \url{https://ecology.ghislainv.fr/geefcc}}

\cvline{\textbf{DownClim}}{(contribution) Le package \textbf{DownClim} permet d’obtenir des projections climatiques à haute résolution spatiale ($\leq$ 1 km) à partir de modèles climatiques mondiaux (CMIP GCM) ou régionaux (CORDEX RCM) à faible résolution ($\geq$ 10 km). \url{https://downclim.readthedocs.io/}}

\vspace{0.3cm}
\subsection{Plugin QGIS}

\cvline{\textbf{deforisk}}{Le plugin \textbf{deforisk} permet l'obtention et la comparaison de cartes de risque de déforestation. \url{https://deforisk-qgis-plugin.org/}}

\section{Encadrement et enseignement}

\cvline{}{Depuis 2009: 1 post-docs ($+$ 2 en collaboration), 4 doctorants ($+$5 en collaboration), 15 stagiaires de Master 2.}

\cvline{\homepagesymbol}{Descriptif complet: \url{https://ecology.ghislainv.fr/people.html}.}

\cvline{2024}{Utilisation du plugin deforisk pour la modélisation du risque de déforestation et la comparaison de cartes de risque. Atelier FAO à Santa-Marta, Colombie, pour les pays d’Amérique latine. 30 participants de six pays: Guatemala, Pérou, Colombie, Chili, Ecuador, Brésil. 5j.}
...
\cvline{$<$ 2009}{Modèles théoriques en écologie. TP. Résolution de systèmes d'équations
  différentielles pour l'étude des mécanismes de coexistence des espèces. Etudiants en
...
\cvline{}{Depuis 2009: 56 articles publiés dans des revues scientifiques de rang A, 5 pre-prints, 5 chapitres d'ouvrages et 3 articles de vulgarisation scientifique. H-index: 39 (GScholar), 30 (WoS).}
